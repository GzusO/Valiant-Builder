...
export const featureData: Feature[] =[
    ...
    {name:'Alchemical Experimentations',types:['Class','Primary','Supplementary','Aspirant'],description:'The practice of alchemy has largely been replaced by more practical processes. However, this doesn\'t keep an eccentric few from honing the talent anyways.', tier:0,abilities:[],traits:[]},
    {name:'Pugilism',types:['Class','Primary','Supplementary','Aspirant'],description:'Bare-knuckled brawlers are a rare sight on the battlefield. Fighting with flesh alone is not easy, but masters of the craft are well-respected', tier:0,abilities:[],traits:[]},
    ...
    {name:'Ascendant Bond',types:['Class','Primary','Supplementary','Aspirant'],description:'Infrequently, ambient energies manifest into peculiar phenomena known as an Ascendants. Ascendants require some sort of host to survive, else they burn up their available energy soon after forming.', tier:0,abilities:[],traits:[]},
    {name:'Marked Prey',types:['Class','Primary','Supplementary','Aspirant'],description:'Once you\'ve got your sights set on something, it\'s only a matter of time before it meets its demise.', tier:0,abilities:[],traits:[]},
    {name:'Charged Blood',types:['Class','Primary','Supplementary','Aspirant'],description:'Whether it\'s hereditary or a freak mutation, your blood contains a significant amount of natural arcane energy. Having most likely lived like this for most of your life, you\'ve become quite adept at making use of this stored energy.', tier:0,abilities:[],traits:[]},
    {name:'Daring Flair',types:['Class','Primary','Supplementary','Aspirant'],description:'Many adventurers learn to fight as a grim necessity. For you, however, a good fight is a great opportunity to try out some fancy new maneuvers.', tier:0,abilities:[],traits:[]},
